...
import cn.com.listener.huang.BuyOutView_ActionListener;



public class AccountItemFrame2 extends JFrame{
		...
		private void init() {
			...
			btnSure.addActionListener(new BuyOutView_ActionListener(this));
			...
			btnExit.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					// TODO Auto-generated method stub
					 ...
					 bov.o=tabView.getValueAt(rowIndex, colIndex); 
					 //System.out.println(biv.o);
					 new BuyOutView(tabView,rowIndex,colIndex);
					 dispose();
					 }
				}
			});
		...
		public void btnSureAction(ActionEvent e) {
			// TODO Auto-generated method stub
			 ...
			 if(colIndex!=1){
				 ...
				 bov.o=this.tabView.getValueAt(rowIndex, colIndex); 
				 //System.out.println(biv.o);
				 new BuyOutView(tabView,rowIndex,colIndex);
				 this.dispose();
			 }
