...
public class Purchase2 extends JDialog{
     ...
     public Purchase2(int a,THGoods app){
    	 this.row=a;
    	 this.aps=app;
	...
	private void init() {
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Vector row =null;
				row=new Vector();
				row.add(Purchase2.this.lblName2.getText().toString());
				row.add(Purchase2.this.lblUnit2.getText().toString());
				row.add(Purchase2.this.txtYuan.getText().toString());
				row.add(Purchase2.this.txtNo.getText().toString());
				row.add(Float.parseFloat(Purchase2.this.txtYuan.getText().toString())*(Float.parseFloat(Purchase2.this.txtNo.getText().toString())));
				
				row.add(Purchase2.this.txtCount.getText().toString());
				row.add(Purchase2.this.txtYear.getText().toString()+"-"+Purchase2.this.txtMonth.getText().toString());
