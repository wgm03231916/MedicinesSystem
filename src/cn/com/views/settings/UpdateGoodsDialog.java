...
import cn.com.service.settings.UpdateGoodsService;
...
public class UpdateGoodsDialog extends JDialog {
	...
	public UpdateGoodsDialog(GoodsInfoDialog gd,String title,boolean model,GoodsBean gb) {
	...
	private void init() {
		...
		UpdateGoodsService ups = new UpdateGoodsService(this,gd,gb);
	...
	private void initData() {
		// TODO Auto-generated method stub
		this.textNO.setText(gb.getGoods_id());
		this.textName.setText(gb.getGoods_Name());
		this.textType.setText(gb.getGoods_type());
		this.textCodes.setText(gb.getGoods_codes());
		
		this.textSpft.setText(gb.getGoods_spft());
		this.textApvlunm.setText(gb.getGoods_Apvlnum());
		this.textSetting.setText(gb.getGoods_setting()+"");
		this.textPrice.setText(gb.getGoods_price()+"");
		this.textManufacture.setText(gb.getGood_manufacture());
		this.textNote.setText(gb.getGoods_note());
